...
In this more advanced lab on Row Level Security, we address two limitations of the previous lab's demo which was readonly for sales users, and required creating a database user for each person.

## Updateable Sales Policy with Shared Connection
