...
# Scenario: Read-Only Sales User Policy

We'll start showing how to use filter predicates in RLS to enable sales users to have read-only access to just their data, while a manager user can read and write all data.
